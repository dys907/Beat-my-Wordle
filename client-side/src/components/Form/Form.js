...
const Form = ({ titleTxt, formType, submitTxt, postLoginHandler }) => {
  ...
  return pageFlow === "login" || pageFlow === "loginError" ? (
    <div className={formStyles.wrapper}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          className={`${styles.defaultButton} ${formStyles.submitBtn}`}
          type="submit"
          value={submitTxt}
        />
      </form>
    ...
    <div className={formStyles.adminWrapper}>
      ...
      <table className={formStyles.adminTable}>
        ...
        <tbody>
          ...
          {adminStats &&
            Object.keys(adminStats["PATCH"]).map((key, i) => (
              <tr>
                <td>{PATCH}</td>
                <td>{key}</td>
                <td>{adminStats["PATCH"][key]} </td>
              </tr>
            ))}
        </tbody>
      </table>
